...
const boleta_1 = require("../utils/boleta");
const router = express_1.default.Router();
// Función para generar número de boleta único
function generarNumBoletaUnico() {
    return __awaiter(this, void 0, void 0, function* () {
        let num_boleta;
        let existe;
        do {
            num_boleta = Math.floor(10000000 + Math.random() * 90000000); // 8 dígitos
            const result = yield db_1.default.query(`SELECT id FROM boleta WHERE num_boleta = $1`, [num_boleta]);
...
router.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const insertPago = yield db_1.default.query(`INSERT INTO pago (id_deuda, monto, fecha_pago, tipo_pago, concepto_pago)
       VALUES ($1, $2, $3, $4, $5)
       RETURNING id_pago`, [id_deuda, monto, fecha_pago, tipoPago, conceptoPago]);
        const id_pago = insertPago.rows[0].id_pago;
        // 2️⃣ Actualizar deuda
        yield db_1.default.query(`UPDATE deuda SET monto = monto - $1 WHERE id_deuda = $2`, [
            monto,
            id_deuda,
        ]);
        // 3️⃣ Obtener información actual de la deuda
        const deudaResult = yield db_1.default.query(`SELECT monto, id_alumno_curso, descripcion, costo_matricula 
       FROM deuda WHERE id_deuda = $1`, [id_deuda]);
        ...
        if (montoActual <= 0) {
            yield db_1.default.query(`UPDATE deuda SET estado = 'pagado', monto = 0 WHERE id_deuda = $1`, [id_deuda]);
        }
        // 5️⃣ Obtener información del alumno + curso
        const alumnoCursoResult = yield db_1.default.query(`SELECT 
          u.correo, 
          a.nombre_completo, 
          a.rut AS rut_alumno,
          a.fono,
       ...
       WHERE ac.id = $1`, [idAlumnoCurso]);
        ...
        const num_boleta = yield generarNumBoletaUnico();
        // 🔹 Insertar boleta en la tabla
        yield db_1.default.query(`INSERT INTO boleta (id_pago, num_boleta) VALUES ($1, $2)`, [id_pago, num_boleta]);
    ...
    `;
        ...
        try {
            const boletaPDF = yield (0, boleta_1.generarBoletaPDF)({
                rut: rutAlumno,
                nombre: nombreAlumno,
                correo: correoAlumno,
                fono: fonoAlumno,
            ...
            yield (0, correo_1.enviarCorreo)(correoAlumno, "Comprobante de pago CFA Educa", mensaje, [
                {
 ...
 * GET /pago/deuda/:id
 */
router.get("/deuda/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const result = yield db_1.default.query(`SELECT id_pago, monto, fecha_pago, tipo_pago, concepto_pago
       FROM pago
       WHERE id_deuda = $1
       ORDER BY fecha_pago DESC`, [id]);
